...
elseif &background == "dark"
    hi Boolean gui=NONE guifg=#a75ee4 guibg=NONE
    ...
    hi Conditional gui=NONE guifg=#ed0c0c guibg=NONE
    ...
    hi Normal gui=NONE guifg=#e6e6c7 guibg=#0c0b0e
    hi Number gui=NONE guifg=#e90c38 guibg=NONE
    ...
    hi Special gui=NONE guifg=#18ec69 guibg=NONE
    ...
    hi Statement gui=NONE guifg=#494edf guibg=NONE
    hi StatusLine gui=NONE guifg=#999999 guibg=#262626
    hi StatusLineNC gui=NONE guifg=#6e6e6e guibg=#262626
    hi StorageClass gui=NONE guifg=#ed0c93 guibg=NONE
    hi String gui=NONE guifg=#d3b522 guibg=NONE
